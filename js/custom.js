...
(function ($) {
	...
	let closeIntroBlock = function () {
		$('.intro-block__item').on('click', function (e) {
			if ($(this).hasClass('intro_index')) {
				e.preventDefault();
				$('.intro-block').fadeOut();
			}
		});
	...
	let linkToIntro = function () {

		const link = document.querySelectorAll('.intro-block__content a');
